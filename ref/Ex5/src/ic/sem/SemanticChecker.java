...
public class SemanticChecker implements Visitor {
	...
	public Object visit(StmtAssignment assignment) {
		...
		assignment.nodeType = a;
		return a;
	}

	@Override
	public Object visit(StmtCall callStatement) {
	    callStatement.nodeType = (Type) callStatement.getCall().accept(this);
		return callStatement.nodeType;
	}
	...
	public Object visit(RefVariable location) {
		...
		if (variable instanceof DeclField)
			location.nodeType = ((DeclField) variable).getType(); 
		else 
		    location.nodeType = (Type) variable;
		 
		return location.nodeType;
	}

	@Override
	public Object visit(RefField location) {
		Type ctype = (Type) location.getObject().accept(this);
		DeclClass c = (DeclClass) location.scope.lookupId(ctype.getDisplayName());
		Object obj = c.scope.lookupId(location.getField());
		DeclField field = null;
		if (obj instanceof DeclField)
		    field = (DeclField) obj;
		...
		location.nodeType = field.getType(); 
		return location.nodeType;
	}
	...
	public Object visit(RefArrayElement location) {
		...
		location.nodeType = reduceDimByOne(result);
		return location.nodeType;
	}
	...
	public Object visit(VirtualCall call) {
		...
		call.nodeType = ((DeclMethod) m).getType();
		return call.nodeType;
	}
	...
	public Object visit(This thisExpression) {
		...
		thisExpression.nodeType = new ClassType(thisExpression.getLine(), lookupClassScopeName(thisExpression.scope));
		return thisExpression.nodeType;
	}
	...
	public Object visit(NewInstance newClass) {
		...
		newClass.nodeType = new ClassType(newClass.getLine(), newClass.getName()); 
		return newClass.nodeType;
	}
	...
	public Object visit(Length length) {
		...
		length.nodeType = new PrimitiveType(length.getLine(), DataType.INT);
		return length.nodeType;
	}
