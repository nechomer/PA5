...
public class PrettyPrinter implements Visitor {
	...
	protected int depth = 0; // depth of indentation

	protected String ICFilePath;
	...
	protected void indent(StringBuffer output, ASTNode node) {
		output.append("\n");
	...
	protected void indent(StringBuffer output) {
		indent(output, null);
	}
